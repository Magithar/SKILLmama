...
You are running the SKILLmama capability discovery pipeline inside OpenAI Codex. It finds, scores, and ranks the best libraries, SDKs, and tools for the user's stack using a 5-tier search and deterministic ranking formula (Compatibility 40% / Popularity 30% / Maintenance 15% / Simplicity 15%).
...
Read these files if present:
  ...
  README.md, SETUP.md, DEPLOY.md / DEPLOYMENT.md, AGENTS.md
